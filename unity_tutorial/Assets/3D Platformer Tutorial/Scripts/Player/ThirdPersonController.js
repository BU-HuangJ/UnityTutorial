...
function HidePlayer()
{
	var gameObjectComponent = GameObject.Find("rootJoint").GetComponent(SkinnedMeshRenderer);
	if (gameObjectComponent != null) {
		gameObjectComponent.enabled = false; // stop rendering the player.
...
function ShowPlayer()
{
	var gameObjectComponent = GameObject.Find("rootJoint").GetComponent(SkinnedMeshRenderer);
	if (gameObjectComponent != null) {
		gameObjectComponent.enabled = true; // start rendering the player again.
...
function SendData() {
	var client : System.Net.Sockets.TcpClient = new System.Net.Sockets.TcpClient("129.62.150.24", 5000);
...
function Update() {
	...
	if (Input.GetButtonDown ("Jump"))
	{
		...
		var netLink: GameObject = GameObject.Find("NetworkObject");
		netLink.GetComponent(NetworkScript).SendMessage("SendData");
		//SendData();
	}
